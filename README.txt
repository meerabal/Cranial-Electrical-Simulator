...
The 3004 Project use cases, sequence diagrams, Traceability Matrix, UML Class Diagram, and Textual Explanation can be found in these folders respectively in the form of pdf files. 
