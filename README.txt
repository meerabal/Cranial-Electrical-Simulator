...
The sub-folders inside Design Documentation folder are: Use Cases, Sequence Diagrams, Traceability Matrix, UML Class Diagram, and the Textual Explanation. 
The 3004 Project use cases, sequence diagrams (8 separate files), Traceability Matrix, UML Class Diagram, and Textual Explanation can be found in these sub folders respectively in the form of pdf files. 
